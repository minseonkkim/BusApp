...
public class BusLineMap {
    ...
    public BusLineMap(int id)throws IOException, org.json.simple.parser.ParseException{
        ...
        */
        ...
        BusLines = new Parse.BusLine[size];
        for(int i=0;i<size;i++)
            BusLines[i] = new Parse.BusLine((JSONObject) jsonArray.get(i));
    }
    ...
    public Parse.BusLine[] getBusLines() { return BusLines; }
